...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/api/products/sub-categories', [ProductController::class, 'getSubCategories'])->name('api.products.sub-categories');
});
...
// Public Shipping API Routes
// ===== WILAYAH DATA (FREE API - Wilayah.id) =====
...
Route::get('/api/shipping/districts', [ShippingController::class, 'getDistricts'])->name('api.shipping.districts');

// Static Pages Routes
Route::get('/tentang-kami', [PageController::class, 'about'])->name('pages.about');
Route::get('/karir', [PageController::class, 'career'])->name('pages.career');
Route::get('/blog', [PageController::class, 'blog'])->name('pages.blog');
Route::get('/blog/{id}', [PageController::class, 'blogDetail'])->name('pages.blog.detail');
...
Route::get('/kebijakan-pengembalian', [PageController::class, 'returnPolicy'])->name('pages.return-policy');
Route::get('/api/shipping/search-provinces', [ShippingController::class, 'searchProvinces'])->name('api.shipping.search-provinces');
Route::get('/api/shipping/search-regencies', [ShippingController::class, 'searchRegencies'])->name('api.shipping.search-regencies');

// ===== RAJAONGKIR (ONLY FOR SHIPPING CALCULATION) =====
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/api/chat/unread-count', [ChatController::class, 'unreadCount'])->name('api.chat.unread-count');
    ...
    Route::post('/chat/{conversationId}/offers/{messageId}/buyer-counter', [OfferController::class, 'buyerCounter'])->name('offers.buyer-counter');
