...
class ProductController extends Controller
{
    ...
    {
        // Only get root categories (parent categories)
        // Sub-categories will be loaded via AJAX when parent is selected
    ...
    /**
     * Get sub-categories for a parent category (AJAX endpoint)
     */
